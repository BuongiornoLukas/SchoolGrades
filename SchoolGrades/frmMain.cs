...
namespace SchoolGrades
{
    public partial class frmMain : Form
    {
        ...
        #endregion
        public SchoolSubject currentSubject;
        ...
        public void loadStudentsData(Student Student)
        {
        ...
        public List<Student> FillListOfChecked(List<Student> StudentsList)
        {
        ...
        {
            Commons.bl.studentGradesSummary();
        ...
        {
            Commons.bl.classesGradeSummary();
            /*if (!CommonsWinForms.CheckIfClassChosen(currentClass))
            {
                return;
            }
        ...
        public void btnStartColorTimer_Click(object sender, EventArgs e)
        {
        ...
        public void ReadCheckSignsIntoCurrentStudentsList()
        {
            int i = 0;
